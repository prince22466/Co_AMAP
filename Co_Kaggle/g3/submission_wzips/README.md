# onnx files are zipped into one and landed here  ,such as w1.zip
# onnx_zipper.py do the above work
# 1 is version, w means wrapper
...
w6 Distribution of ONNX files:
Total ONNX files zipped: 230
...
w7 Distribution of ONNX files:
Total ONNX files zipped: 298
...
w8 Distribution of ONNX files:
Total ONNX files zipped: 347
