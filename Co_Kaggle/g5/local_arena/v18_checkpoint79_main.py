"""Kaggriculture v18 development checkpoint.
Demand-aware herd, earlier crop planting, and extended daily planting hours.
Validation is incomplete: see local_arena/v18_checkpoint.md.
"""
import math
