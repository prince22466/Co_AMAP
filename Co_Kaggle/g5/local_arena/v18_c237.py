...
def crop_plan(obs,projected,animal):
    ...
    wheat=set(opening[:4]);melon=set(opening[4:19])
    for p in points:
        t=tile(f,p)
...
def market_orders(obs,animal,crops,actions):
    ...
    if day==0 and hour==0:
        return [['BUY_SEED', 'WHEAT', 4], ['BUY_SEED', 'MELON', 15], ['BUY_ANIMAL', 'COW', 2], ['BUY_ANIMAL', 'SHEEP', 2], ['BUY_PRODUCT', 'WHEAT', 4], ['HIRE'], ['HIRE'], ['HIRE'], ['HIRE'], ['HIRE']]
