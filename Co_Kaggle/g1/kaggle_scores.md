...
| LoRA-001 | TBD | LoRA SFT | L_R = 4;L_A = 8; MODULES = in_proj, out_proj, up_proj, down_proj; LORA_DROPOUT = 0.05; LORA_BIAS = "none"; TASK_TYPE = TaskType.CAUSAL_LM | TBD | TBD | TBD | TBD | TBD |  |
