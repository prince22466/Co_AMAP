...
| LoRA-001 | TBD | LoRA SFT | L_R = 4;L_A = 8; MODULES = in_proj, out_proj, up_proj, down_proj; L_dropout = 0.05; L_BIAS = "none"; TYPE = TaskType.CAUSAL_LM | "TRAIN_FRACTION": 0.80,
    "EP": 4,
    "MAX_STEPS": None,
    ...
    "SAVE_ADAPTER": True,
    "ADAPTER_OUTPUT_DIR": OUTPUT_DIR, | TBD | TBD | TBD | TBD |  |
