...
| LoRA-003 | TBA | LoRA SFT | L_R = 4;L_A = 8; MODULES = [in_proj, out_proj]; L_dropout = 0.05; L_BIAS = "none"; TYPE = TaskType.CAUSAL_LM |  TRAIN_FRACTION: 0.80; EP: 20; MAX_STEPS: None; BATCH_SIZE: 2; GRAD_ACC_STEPS: 10; L_RATE: 1e-4; MAX_LENGTH: 512; MAX_NEW_TOKENS: 32; EARLY_STOPPING: True; EVAL_EVERY_STEPS: 6; EARLY_STOPPING_VAL_ROWS: 50; STOP_WHEN_VAL_WORSE: True | keep_0250_stratified_feature_coverage on train.csv(250 rows) | |  | |  |
