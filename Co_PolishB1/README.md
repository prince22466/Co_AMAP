How did I get TELC Polish B1 done in 4.5 months(accumulative) with AI and luck.
...
preparation time : Oct End - Dec 12
1st exam

how is i used AI, at that time 
much of time spending on reading( in the begining ) and writing.
Reading and language element
listening: i bascially practice with these online videos
...
for part 2, it is prezentation. i write it first and ask GPT give opinions and changes. i read these versions. still not fluent but i can speak.
for part 3, didnt do that much on this. my listening is not good, i cannot understand what AI is talking about. that is reason.
I think for 1st, I used gpt to allow to give speak for part 1 and part 2. which is very important first step.
I was able to say some A2 level sentence rather fluent.
I didnt expect speaking part can pass, but i think there was a chance.
The writing passed was good signal, which I did some confidence. The reading+language element+listening pass was luck, cause my listening is basically guessing.but it doesnt matter.
...
preparation time 3: Apr 4 - Apr 24
3rd exam
same thing for listening, writing. didnt even review reading+ language element.
still work on speaking based on  same material in preparation time 2. 
didnt do much new. just enhence and repeat what i did in preparation time 2.
i just become more fluent via more iteration.
eventually i can do prezentation in 2 mins without taking notes, conversation with 5,6 exchanges rather easily.
and continue the conversation without understanding what the other guys i talking about.
